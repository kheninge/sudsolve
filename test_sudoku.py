...
def test_sudoku_elimination_to_one():
    ...
    """
    puzzle = Sudoku()
    init1 = ((2, None, None, 5, 7, None, None, 1, None),
    ...
    sols1 = ((2, None, None, 5, 7, None, 9, 1, 8),
             (None, 7, None, None, None, 4, None, None, 6),
             (None, 8, 6, None, None, None, None, 4, 3),
...
def test_sudoku_simple_solved_after_multiple_calls():
    ...
    while progress:
        progress = puzzle.single_possible_location()
    sols = puzzle.solutions
    assert sols == ((2, 4, 3, 5, 7, 6, 9, 1, 8), (9, 7, 1, 3, 8, 4, 2, 5, 6), (5, 8, 6, 9, 2, 1, 7, 4, 3), (4, 3, 2, 7, 6, 1, 8, 5, 9), (8, 6, 9, 5, 4, 2, 1, 3, 7), (1, 5, 7, 3, 9, 8, 4, 6, 2), (3, 9, 4, 6, 2, 5, 1, 8, 7), (7, 2, 8, 4, 1, 3, 6, 9, 5), (6, 1, 5, 8, 7, 9, 2, 3, 4))
